...
import Create from "./components/productCreated";
import { motion } from "framer-motion";
import React from "react";
import { AuroraBackground } from "./components/homeBackround";
...
export default function Home() {
  ...
  return (
    <AuroraBackground>
      ...
      >
        <h1 className="font-bold text-[48px] text-white text-center relative bottom-[100px] z-0 w-full">
          Product List & Add <br />
          WELCOME!
        </h1>
        ...
        <div className="relative flex flex-col justify-center overflow-hidden py-6 ">
            ...
            <div className="relative z-10 mx-auto max-w-md">
              ...
              <div className="space-y-6 pt-5 text-base leading-7 text-gray-600 transition-all duration-300 group-hover:text-white/90">
                ...
                <button
                  ...
                  type="button"
                  className="px-3 py-2 ml-4 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
                >
                  yeni ekle
                </button>
              </div>
          ...
          <FullScreenModal show={showModal} onClose={closeModal}>
            <ProductList />
          </FullScreenModal>

          <Create show={addShowModal} onClose={closeAddModal} />
        </div>
      </motion.div>
    </AuroraBackground>
  );
